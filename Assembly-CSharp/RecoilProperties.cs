...
public class RecoilProperties : ScriptableObject
{
	...
	public float clampPitch = Single.NegativeInfinity;

	public AnimationCurve pitchCurve = new AnimationCurve(new Keyframe[] { new Keyframe(0f, 1f), new Keyframe(1f, 1f) });

	public AnimationCurve yawCurve = new AnimationCurve(new Keyframe[] { new Keyframe(0f, 1f), new Keyframe(1f, 1f) });
