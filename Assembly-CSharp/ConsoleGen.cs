...
public class ConsoleGen
{
	...
	static ConsoleGen()
	{
		ConsoleSystem.Command[] command = new ConsoleSystem.Command[537];
		...
		command[2] = new ConsoleSystem.Command()
		{
			...
			SetOveride = (string str) => BaseRidableAnimal.decayminutes = str.ToFloat(0f)
		};
		...
		command[189] = new ConsoleSystem.Command()
		{
			...
			ServerUser = true,
			Variable = false,
			Call = (ConsoleSystem.Arg arg) => Debugging.gesture(arg)
		};
		...
		command[245] = new ConsoleSystem.Command()
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.GC.enabled.ToString(),
			SetOveride = (string str) => ConVar.GC.enabled = str.ToBool()
		};
		command[246] = new ConsoleSystem.Command()
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.GC.incremental_enabled.ToString(),
			SetOveride = (string str) => ConVar.GC.incremental_enabled = str.ToBool()
		};
		command[247] = new ConsoleSystem.Command()
		{
			...
			ServerAdmin = true,
			Variable = true,
			GetOveride = () => ConVar.GC.incremental_milliseconds.ToString(),
			SetOveride = (string str) => ConVar.GC.incremental_milliseconds = str.ToInt(0)
		};
		...
		command[291] = new ConsoleSystem.Command()
		{
			...
			ServerAdmin = true,
			Variable = false,
			Call = (ConsoleSystem.Arg arg) => Inventory.defs(arg)
		};
		...
		command[299] = new ConsoleSystem.Command()
		{
			...
			ServerAdmin = true,
			Variable = false,
			Call = (ConsoleSystem.Arg arg) => Inventory.reloaddefs(arg)
		};
		...
		command[304] = new ConsoleSystem.Command()
		{
			...
			ServerAdmin = true,
			Variable = false,
			Call = (ConsoleSystem.Arg arg) => MemSnap.full(arg)
		};
		command[305] = new ConsoleSystem.Command()
		{
			...
			ServerAdmin = true,
			Variable = false,
			Call = (ConsoleSystem.Arg arg) => MemSnap.managed(arg)
		};
		command[306] = new ConsoleSystem.Command()
		{
			...
			ServerAdmin = true,
			Variable = false,
			Call = (ConsoleSystem.Arg arg) => MemSnap.native(arg)
		};
		...
		command1 = new ConsoleSystem.Command()
		{
			...
			SetOveride = (string str) => RidableHorse.Population = str.ToFloat(0f)
		};
