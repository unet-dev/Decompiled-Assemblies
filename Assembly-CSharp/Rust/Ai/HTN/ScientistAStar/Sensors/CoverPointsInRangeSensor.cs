...
namespace Rust.Ai.HTN.ScientistAStar.Sensors
{
	...
	public class CoverPointsInRangeSensor : INpcSensor
	{
		...
		public void Tick(IHTNAgent npc, float deltaTime, float time)
		{
			...
			this._FindCoverPointsInVolume(npc, npc.transform.position, aiDomain.ScientistContext.CoverPoints, ref aiDomain.ScientistContext.CoverVolume, ref this.nextCoverPosInfoTick, time, aiDomain.ScientistContext.Location, allowedCoverRangeSqr);
		}
