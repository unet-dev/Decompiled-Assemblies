...
namespace SteamNative
{
	internal struct GetOPFSettingsResult_t
	{
		...
		{
			GetOPFSettingsResult_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			GetOPFSettingsResult_t getOPFSettingsResultT = GetOPFSettingsResult_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<GetOPFSettingsResult_t>(getOPFSettingsResultT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<GetOPFSettingsResult_t>(getOPFSettingsResultT);
			}
		}
