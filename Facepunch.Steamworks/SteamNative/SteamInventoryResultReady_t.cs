...
namespace SteamNative
{
	internal struct SteamInventoryResultReady_t
	{
		...
		{
			SteamInventoryResultReady_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			SteamInventoryResultReady_t steamInventoryResultReadyT = SteamInventoryResultReady_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<SteamInventoryResultReady_t>(steamInventoryResultReadyT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<SteamInventoryResultReady_t>(steamInventoryResultReadyT);
			}
		}
