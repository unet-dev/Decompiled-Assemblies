...
namespace SteamNative
{
	internal struct HTML_HideToolTip_t
	{
		...
		{
			HTML_HideToolTip_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			HTML_HideToolTip_t hTMLHideToolTipT = HTML_HideToolTip_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<HTML_HideToolTip_t>(hTMLHideToolTipT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<HTML_HideToolTip_t>(hTMLHideToolTipT);
			}
		}
