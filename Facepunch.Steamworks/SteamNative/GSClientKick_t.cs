...
namespace SteamNative
{
	internal struct GSClientKick_t
	{
		...
		{
			GSClientKick_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			GSClientKick_t gSClientKickT = GSClientKick_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<GSClientKick_t>(gSClientKickT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<GSClientKick_t>(gSClientKickT);
			}
		}
		...
		internal struct PackSmall
		{
			...
			{
				GSClientKick_t gSClientKickT = new GSClientKick_t()
				{
					SteamID = d.SteamID,
					DenyReason = d.DenyReason
				};
				return gSClientKickT;
			}
		}
	}
}