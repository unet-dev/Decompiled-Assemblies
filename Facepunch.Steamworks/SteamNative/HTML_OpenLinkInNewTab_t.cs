...
namespace SteamNative
{
	internal struct HTML_OpenLinkInNewTab_t
	{
		...
		{
			HTML_OpenLinkInNewTab_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			HTML_OpenLinkInNewTab_t hTMLOpenLinkInNewTabT = HTML_OpenLinkInNewTab_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<HTML_OpenLinkInNewTab_t>(hTMLOpenLinkInNewTabT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<HTML_OpenLinkInNewTab_t>(hTMLOpenLinkInNewTabT);
			}
		}
