...
namespace SteamNative
{
	internal struct PS3TrophiesInstalled_t
	{
		...
		{
			PS3TrophiesInstalled_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			PS3TrophiesInstalled_t pS3TrophiesInstalledT = PS3TrophiesInstalled_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<PS3TrophiesInstalled_t>(pS3TrophiesInstalledT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<PS3TrophiesInstalled_t>(pS3TrophiesInstalledT);
			}
		}
