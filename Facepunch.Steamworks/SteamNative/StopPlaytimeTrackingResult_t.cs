...
namespace SteamNative
{
	internal struct StopPlaytimeTrackingResult_t
	{
		...
		{
			StopPlaytimeTrackingResult_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			StopPlaytimeTrackingResult_t stopPlaytimeTrackingResultT = StopPlaytimeTrackingResult_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<StopPlaytimeTrackingResult_t>(stopPlaytimeTrackingResultT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<StopPlaytimeTrackingResult_t>(stopPlaytimeTrackingResultT);
			}
		}
