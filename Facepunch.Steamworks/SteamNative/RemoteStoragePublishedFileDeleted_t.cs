...
namespace SteamNative
{
	internal struct RemoteStoragePublishedFileDeleted_t
	{
		...
		{
			RemoteStoragePublishedFileDeleted_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			RemoteStoragePublishedFileDeleted_t remoteStoragePublishedFileDeletedT = RemoteStoragePublishedFileDeleted_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<RemoteStoragePublishedFileDeleted_t>(remoteStoragePublishedFileDeletedT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<RemoteStoragePublishedFileDeleted_t>(remoteStoragePublishedFileDeletedT);
			}
		}
