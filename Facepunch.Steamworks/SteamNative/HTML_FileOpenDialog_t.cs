...
namespace SteamNative
{
	internal struct HTML_FileOpenDialog_t
	{
		...
		{
			HTML_FileOpenDialog_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			HTML_FileOpenDialog_t hTMLFileOpenDialogT = HTML_FileOpenDialog_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<HTML_FileOpenDialog_t>(hTMLFileOpenDialogT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<HTML_FileOpenDialog_t>(hTMLFileOpenDialogT);
			}
		}
