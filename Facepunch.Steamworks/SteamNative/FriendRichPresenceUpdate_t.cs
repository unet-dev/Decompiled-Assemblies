...
namespace SteamNative
{
	internal struct FriendRichPresenceUpdate_t
	{
		...
		{
			FriendRichPresenceUpdate_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			FriendRichPresenceUpdate_t friendRichPresenceUpdateT = FriendRichPresenceUpdate_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<FriendRichPresenceUpdate_t>(friendRichPresenceUpdateT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<FriendRichPresenceUpdate_t>(friendRichPresenceUpdateT);
			}
		}
		...
		internal struct PackSmall
		{
			...
			{
				FriendRichPresenceUpdate_t friendRichPresenceUpdateT = new FriendRichPresenceUpdate_t()
				{
					SteamIDFriend = d.SteamIDFriend,
					AppID = d.AppID
				};
				return friendRichPresenceUpdateT;
			}
		}
	}
}