...
namespace SteamNative
{
	internal struct SteamParentalSettingsChanged_t
	{
		...
		{
			SteamParentalSettingsChanged_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			SteamParentalSettingsChanged_t steamParentalSettingsChangedT = SteamParentalSettingsChanged_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<SteamParentalSettingsChanged_t>(steamParentalSettingsChangedT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<SteamParentalSettingsChanged_t>(steamParentalSettingsChangedT);
			}
		}
