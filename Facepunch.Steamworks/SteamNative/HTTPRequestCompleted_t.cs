...
namespace SteamNative
{
	internal struct HTTPRequestCompleted_t
	{
		...
		{
			HTTPRequestCompleted_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			HTTPRequestCompleted_t hTTPRequestCompletedT = HTTPRequestCompleted_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<HTTPRequestCompleted_t>(hTTPRequestCompletedT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<HTTPRequestCompleted_t>(hTTPRequestCompletedT);
			}
		}
