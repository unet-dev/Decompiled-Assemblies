...
namespace SteamNative
{
	internal struct HTML_NewWindow_t
	{
		...
		{
			HTML_NewWindow_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			HTML_NewWindow_t hTMLNewWindowT = HTML_NewWindow_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<HTML_NewWindow_t>(hTMLNewWindowT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<HTML_NewWindow_t>(hTMLNewWindowT);
			}
		}
