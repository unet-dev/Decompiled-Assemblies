...
namespace SteamNative
{
	internal struct GlobalStatsReceived_t
	{
		...
		{
			GlobalStatsReceived_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			GlobalStatsReceived_t globalStatsReceivedT = GlobalStatsReceived_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<GlobalStatsReceived_t>(globalStatsReceivedT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<GlobalStatsReceived_t>(globalStatsReceivedT);
			}
		}
