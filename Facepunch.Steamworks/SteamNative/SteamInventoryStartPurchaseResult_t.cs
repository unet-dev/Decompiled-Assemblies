...
namespace SteamNative
{
	internal struct SteamInventoryStartPurchaseResult_t
	{
		...
		{
			SteamInventoryStartPurchaseResult_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			SteamInventoryStartPurchaseResult_t steamInventoryStartPurchaseResultT = SteamInventoryStartPurchaseResult_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<SteamInventoryStartPurchaseResult_t>(steamInventoryStartPurchaseResultT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<SteamInventoryStartPurchaseResult_t>(steamInventoryStartPurchaseResultT);
			}
		}
