...
namespace SteamNative
{
	internal struct AvatarImageLoaded_t
	{
		...
		{
			AvatarImageLoaded_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			AvatarImageLoaded_t avatarImageLoadedT = AvatarImageLoaded_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<AvatarImageLoaded_t>(avatarImageLoadedT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<AvatarImageLoaded_t>(avatarImageLoadedT);
			}
		}
		...
		internal struct PackSmall
		{
			...
			{
				AvatarImageLoaded_t avatarImageLoadedT = new AvatarImageLoaded_t()
				{
					SteamID = d.SteamID,
					Image = d.Image,
					Wide = d.Wide,
