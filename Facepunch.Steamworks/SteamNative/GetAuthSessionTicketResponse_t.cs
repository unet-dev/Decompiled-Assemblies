...
namespace SteamNative
{
	internal struct GetAuthSessionTicketResponse_t
	{
		...
		{
			GetAuthSessionTicketResponse_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			GetAuthSessionTicketResponse_t getAuthSessionTicketResponseT = GetAuthSessionTicketResponse_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<GetAuthSessionTicketResponse_t>(getAuthSessionTicketResponseT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<GetAuthSessionTicketResponse_t>(getAuthSessionTicketResponseT);
			}
		}
