...
namespace SteamNative
{
	internal struct DownloadItemResult_t
	{
		...
		{
			DownloadItemResult_t.OnResultWithInfo(param, false, (long)0);
		}
		...
		internal static void OnResultWithInfo(IntPtr param, bool failure, SteamAPICall_t call)
		{
			...
			DownloadItemResult_t downloadItemResultT = DownloadItemResult_t.FromPointer(param);
			if (Client.Instance != null)
			{
				Client.Instance.OnCallback<DownloadItemResult_t>(downloadItemResultT);
			}
			if (Server.Instance != null)
			{
				Server.Instance.OnCallback<DownloadItemResult_t>(downloadItemResultT);
			}
		}
